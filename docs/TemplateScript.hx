...
// Event notes hooks
function onEvent(name:String, value1:String, value2:String, value3:String, value4:String, value5:String, value6:String, strumTime:Float)
{
...
function onEventPushed(name:String, value1:String, value2:String, value3:String, value4:String, value5:String, value6:String, strumTime:Float)
{
